namespace StoreMovie.Api.WebUI.Areas.Promotion.Controllers;
...
using StoreMovie.Api.Application.PromotionApplication.Commands.UpdatePromotion;
using StoreMovie.Api.Application.PromotionApplication.Commands.UpdatePromotionByValidityDate;
using StoreMovie.Api.Application.PromotionApplication.Queries.GetAll;
using StoreMovie.Api.Application.PromotionApplication.Queries.GetAllPagination;
using StoreMovie.Api.Application.PromotionApplication.Queries.GetByFilters;
