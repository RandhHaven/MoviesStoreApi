using StoreMovie.Api.Application;
using StoreMovie.Api.Application.Common.Interfaces;
using StoreMovie.Api.Infrastructure;
using StoreMovie.Api.Infrastructure.Persistence;
using StoreMovie.Api.WebUI.Services;
using FluentValidation.AspNetCore;
using Microsoft.AspNetCore.Mvc;
using StoreMovie.Api.WebUI.Filters;
using Microsoft.OpenApi.Models;
using StoreMovie.Api.WebUI.Helpers;

namespace StoreMovie.Api.WebUI;
